...
Join Group : https://chat.whatsapp.com/HN6Hgv8oRegG1GOTUE5HjU`
            wa.FakeStatusImgForwarded(from, fakeimage, textnya, fake)
            reply(`Join Group : https://chat.whatsapp.com/HN6Hgv8oRegG1GOTUE5HjU`)
                break
            case 'otakuongoing':
                o = await onGoing()
                console.log(o)
            ...
            case 'cnn':
                ...
                break
            case 'owner':
                await wa.sendContact(from, owner, "MICHAEL AGAM")
                break
            case 'tiktok':
                url = args.join(" ")
